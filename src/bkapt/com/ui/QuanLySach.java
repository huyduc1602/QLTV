...
public class QuanLySach extends javax.swing.JInternalFrame {
    ...
    public void insert(){
        ...
        if (sdao.insert(s)>0 )
        {    
            JOptionPane.showMessageDialog(null, "ThÃªm SÃ¡ch thÃ nh cÃ´ng");
        }
        else{
            JOptionPane.showMessageDialog(null, "MÃ£ SÃ¡ch [ "+txtMaSach.getText()+" ] Ä‘Ã£ tá»“n táº¡i khÃ´ng thá»ƒ thÃªm");
        }     
