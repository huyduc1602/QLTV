...
//             listMaSach.add(s);
    ...
    public void insert(){
        ...
        SinhVien svChon = (SinhVien) cboSinhVien.getSelectedItem();
        pm.setMaSV(svChon.getMaSV());
        if (modelList.getSize() > 0) {
             for (int i = 0; i < modelList.getSize(); i++) {
                Object item = modelList.getElementAt(i);
                pm.setMaPhieuMuon((String) item);
            }
        }else{
            JOptionPane.showMessageDialog(null, "Vui lÃ²ng chá»n sÃ¡ch mÆ°á»£n !");
        }
        ...
        PhieuMuonDAO pmdao =new PhieuMuonDAO() ;
         ...
         for (int i = 0; i < modelList.getSize(); i++) {
             for (Sach s : listSach) {
                ...
                {    
                    JOptionPane.showMessageDialog(null, "ThÃªm Phiáº¿u MÆ°á»£n thÃ nh cÃ´ng");
                }
                else{
                    JOptionPane.showMessageDialog(null, "Vui lÃ²ng nháº­p Ä‘Ãºng thÃ´ng tin trong Phiáº¿u MÆ°á»£n");
                }      
                 }
             }
                 ...
                 if (s.equals(modelList.getElementAt(i).toString())) {
                    if (pmdao.update(pm,s.getMaSach())>0 )
                       {    
                           ...
                           JOptionPane.showMessageDialog(null, "cáº­p nháº­t tháº¥t báº¡i");
                       }  
                     }
             }
        }
    ...
    public void delete(){
        ...
        if (index == -1) {
            JOptionPane.showMessageDialog(this, "Vui lÃ²ng chá»n 1 Phiáº¿u MÆ°á»£n trong báº£ng Ä‘á»ƒ xÃ³a", "ThÃ´ng BÃ¡o", 1);
            return;
        }
        PhieuMuonDAO pmdao = new PhieuMuonDAO();
        
        int tk = JOptionPane.showConfirmDialog(this, "Báº¡n cÃ³ muá»‘n xÃ³a khÃ´ng");
      if (tk==JOptionPane.YES_OPTION)  
      {
        if (pmdao.delete(txtMaPhieuMuon.getText()))
        {
            JOptionPane.showMessageDialog(this, "XÃ³a Phiáº¿u MÆ°á»£n thÃ nh cÃ´ng", "ThÃ´ng BÃ¡o", 1);
            
        } else {
            JOptionPane.showMessageDialog(this, "Lá»—i há»‡ thá»‘ng", "ThÃ´ng BÃ¡o", 0);
        }
...
//            txtMaSach.requestFocus();
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(lblMaSV1, javax.swing.GroupLayout.DEFAULT_SIZE, 151, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1160, Short.MAX_VALUE)
        );
